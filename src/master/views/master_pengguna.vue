<template>	
	<div class="bg-gray-50 h-full">
		...
		<Header title="Daftar Pengguna" subtitle="Kelola daftar pengguna disini" @refresh="getDataTable()"/>
		...
		<div class="rounded-md shadow mx-10 relative bg-white">
			<div class="flex px-5 pt-4 pb-4 relative">
				...
				<div class="absolute right-10 top-1/2 -translate-y-2/4 transform mt-1">
					<p @click="directForm()" class="green-button"><Plus class="mr-2 -mt-1"/>Tambah Pengguna</p>
